...
| Что | Цвет |
|---|---|
| Фракции | Цвет — данные фракции, игрок выбирает. Пресеты: cyan, magenta, amber, lime. Два цвета в дуэли должны различаться по яркости, не только по тону (дальтонизм) |
...
Панели генома и создания фракции — модальные экраны.
