...
public static class Iso
{
    ...
    /// <summary>
    /// Статичная функция возврата вектора скорости по вводу
    /// вводящей изометрическую поправку по вертикали.
    /// </summary>
    ...
    /// <summary>
    /// Статичная функция возврата центра клетки в мировых координатах.
    /// Конвенция Godot для Diamond Down: клетка (0,0)
    /// лежит в прямоугольнике от (0,0) до (TileWidth, TileHeight).
    /// </summary>
    ...
    /// <summary>
    /// Статичная функция возврата расстояния между мировыми координатами,
    /// где вертикаль сжата по ScaleY.
    /// </summary>
